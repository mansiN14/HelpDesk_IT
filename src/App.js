...
const renderKnowledgeBase = () => {
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold mb-8">
        {language === "English" ? "Knowledge Base" : "ज्ञान आधार"}
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white bg-opacity-70 backdrop-blur-sm p-4 rounded-md shadow">
          <h2 className="text-lg font-medium mb-4">
            {language === "English" ? "Network Issues" : "नेटवर्क समस्या"}
          </h2>
          <p className="text-gray-600 mb-4">
            {language === "English" 
              ? "Common network problems and their solutions" 
              : "सामान्य नेटवर्क समस्या आणि त्यांची उत्तरे"}
          </p>
          <ul className="space-y-2">
            <li className="hover:bg-gray-50 p-2 rounded">
              <a href="#" className="block">
                {language === "English" ? "How to troubleshoot Wi-Fi connectivity" : "वाय-फाय कनेक्टिव्हिटी समस्या निवारण कसे करावे"}
              </a>
            </li>
            <li className="hover:bg-gray-50 p-2 rounded">
              <a href="#" className="block">
                {language === "English" ? "Common network error codes" : "सामान्य नेटवर्क त्रुटी कोड"}
              </a>
            </li>
            <li className="hover:bg-gray-50 p-2 rounded">
              <a href="#" className="block">
                {language === "English" ? "VPN connection issues" : "व्हीपीएन कनेक्शन समस्या"}
              </a>
            </li>
          </ul>
          <button className="text-purple-500 mt-4">
            {language === "English" ? "View Articles" : "लेख पहा"}
          </button>
        </div>
        
        <div className="bg-white bg-opacity-70 backdrop-blur-sm p-4 rounded-md shadow">
          <h2 className="text-lg font-medium mb-4">
            {language === "English" ? "Software & Applications" : "सॉफ्टवेअर आणि अॅप्लिकेशन्स"}
          </h2>
          <p className="text-gray-600 mb-4">
            {language === "English" 
              ? "Step-by-step guides for software installation" 
              : "सॉफ्टवेअर इंस्टॉलेशनसाठी चरण-दर-चरण मार्गदर्शक"}
          </p>
          <ul className="space-y-2">
            <li className="hover:bg-gray-50 p-2 rounded">
              <a href="#" className="block">
                {language === "English" ? "Office 365 troubleshooting" : "ऑफिस ३६५ समस्या निवारण"}
              </a>
            </li>
            <li className="hover:bg-gray-50 p-2 rounded">
              <a href="#" className="block">
                {language === "English" ? "Email configuration" : "ईमेल कॉन्फिगरेशन"}
              </a>
            </li>
            <li className="hover:bg-gray-50 p-2 rounded">
              <a href="#" className="block">
                {language === "English" ? "Software installation guide" : "सॉफ्टवेअर इंस्टॉलेशन मार्गदर्शक"}
              </a>
            </li>
          </ul>
          <button className="text-purple-500 mt-4">
        ...
        <div className="bg-white bg-opacity-70 backdrop-blur-sm p-4 rounded-md shadow">
          <h2 className="text-lg font-medium mb-4">
            {language === "English" ? "Hardware Support" : "हार्डवेअर सपोर्ट"}
          </h2>
          <p className="text-gray-600 mb-4">
            {language === "English" 
              ? "Solutions for common hardware issues" 
              : "सामान्य हार्डवेअर समस्यांसाठी उपाय"}
          </p>
          <ul className="space-y-2">
            <li className="hover:bg-gray-50 p-2 rounded">
              <a href="#" className="block">
                {language === "English" ? "Printer setup and troubleshooting" : "प्रिंटर सेटअप आणि समस्या निवारण"}
              </a>
            </li>
            <li className="hover:bg-gray-50 p-2 rounded">
              <a href="#" className="block">
                {language === "English" ? "Monitor and display issues" : "मॉनिटर आणि डिस्प्ले समस्या"}
              </a>
            </li>
            <li className="hover:bg-gray-50 p-2 rounded">
              <a href="#" className="block">
                {language === "English" ? "Laptop battery problems" : "लॅपटॉप बॅटरी समस्या"}
              </a>
            </li>
          </ul>
          <button className="text-purple-500 mt-4">
        ...
        <div className="w-full md:w-64 bg-white bg-opacity-70 backdrop-blur-sm rounded-md shadow p-4 mb-6 md:mb-0 md:mr-6 overflow-auto">
          <nav>
            <ul className="space-y-1">
              ...
              <li>
                <button
                  className={`flex items-center space-x-3 w-full p-2 rounded-md ${activeTab === "knowledgeBase" ? "bg-purple-50 text-purple-600" : "hover:bg-gray-50"}`}
                  onClick={() => setActiveTab("knowledgeBase")}
                >
                  <BookOpen size={20} />
                  <span>{language === "English" ? "Knowledge Base" : "ज्ञान आधार"}</span>
                </button>
              </li>
              <li>
                <button
